...
r = 7
circle = Circle(r)
circle_area = Circle.calculate_area(circle)
circle_perimeter = Circle.calculate_perimeter(circle)
...
rectangle_area = Rectangle.calculate_area(rectangle)
rectangle_perimeter = Rectangle.calculate_perimeter(rectangle)
...
triangle_perimeter = Triangle.calculate_perimeter(triangle)
